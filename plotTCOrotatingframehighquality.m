...
plot3(-mean(moonx),0,0,"Marker",".","Color","k","MarkerSize",10)
...
view(0,0)   % XZ
legend("2006RH_{120} \color{white} TC\color{black}","Earth","Moon","Burn 1 & 2","Transfer","Burn 3","TCO & S/C","Location",'northeast','Position',[0.7 0.7 0.1 0.1])
%title("Mission Trajectory to 2006RH120 in 2028")
xlabel("x (LD)")
ylabel("y (LD)")
zlabel("z (LD)")

%exportgraphics(gca,'RH120rotatinghighquality.jpeg','Resolution',2000)
